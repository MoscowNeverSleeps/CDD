...
RATIO_FORMULAS = {
    "Коэффициент финансовой устойчивости": "(1300 + 1400) / 1700",
    "Коэффициент автономии": "1300 / 1600",
    "Коэффициент обеспеченности собственными средствами": "(1300 - 1100) / 1200",
    "Отношение дебиторской задолженности к активам": "1230 / 1600",
    "Коэффициент соотношения заемного и собственного капитала": "(1410 + 1510) / 1300",
    "Коэффициент абсолютной ликвидности": "(1250 + 1240) / 1500",
    "Коэффициент текущей ликвидности": "1200 / 1500",
    "Коэффициент обеспеченности обязательств активами": "(1600 - 1220) / (1520 + 1510 + 1550 + 1400)",
    "Степень платежеспособности по текущим обязательствам": "(1510 + 1520 + 1550) / (2110 / 12)",
    "Коэффициент утраты платежеспособности": "(КТЛк + 3 х (КТЛк - КТЛн)) / 2",
    "Рентабельность продаж, %": "(2110 - 2120 - 2210 - 2220) / 2110",
    "Рентабельность затрат, %": "(2110 - 2120 - 2210 - 2220) / (2120 + 2210 + 2220)",
    "Рентабельность активов, %": "2400 / ((1600н + 1600к) / 2)",
    "Рентабельность собственного капитала, %": "2400 / ((1300н + 1300к) / 2)",
    "Оборачиваемость дебиторской задолженности": "2110 / ((1230н + 1230к) / 2)",
    "Оборачиваемость кредиторской задолженности": "2120 / ((1520н + 1520к) / 2)",
    "Коэффициент финансового рычага": "(1400 + 1500) / 1300",
    "Тип финансовой устойчивости": "Сравнение запасов с источниками формирования"
}
